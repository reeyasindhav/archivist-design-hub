...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      { title: "Create account — Archiquest" },
      {
        name: "description",
        content: "Join Archiquest to save works, follow architects, and submit projects.",
      },
    ],
  }),
  component: Signup,
    ...
    return (
      <div className="mx-auto max-w-[1400px] px-5 py-14 lg:px-10">
        <div className="mx-auto max-w-md text-center">
          <p className="font-display text-2xl">Creating your account…</p>
        </div>
      </div>
    );
  }
    ...
    <div className="mx-auto max-w-[1400px] px-5 py-14 lg:px-10">
      ...
      <div className="mx-auto grid max-w-5xl lg:grid-cols-[1fr_420px]">
        ...
        <div className="lg:pl-12">
          <Reveal>
            <p className="rule-label">Join the archive</p>
            <h1 className="mt-4 font-display text-3xl">Create your account</h1>
            <p className="mt-2 text-sm text-ink-soft">
              Start saving works, following architects, and sharing your own projects.
            </p>
          </Reveal>
          ...
          <form onSubmit={handleSubmit} className="mt-10 space-y-5">
            ...
            <div>
              ...
              <select
                ...
                className="mt-2 w-full border border-border bg-transparent px-4 py-3 text-sm outline-none transition-colors focus:border-accent"
              >
                <option value="enthusiast">Design enthusiast</option>
